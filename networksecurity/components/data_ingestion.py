...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        ...
        try:
            ...
            if df.empty:
                raise ValueError(f"No data found in collection '{collection_name}' of database '{database_name}'")
            ...
            raise NetworkSecurityException(e, sys)  # ✅ FIXED: Added (e, sys)
    ...
    def split_data_as_train_test(self,dataframe: pd.DataFrame):
        try:
            # Check if dataframe has data before splitting
